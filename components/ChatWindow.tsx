        ...
        <ul>
          ...
          <li>
            ...
            <span className="ml-2">
              ...
              <br/>
              <pre className="inline-flex px-2 py-1 my-2 rounded">$ OLLAMA_ORIGINS=https://fully-local-pdf-chatbot-alpha.vercel.app OLLAMA_HOST=127.0.0.1:11435 ollama serve
              </pre>
              <br/>
